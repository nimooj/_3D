================================================================================
    MFC 라이브러리 : Gaia 프로젝트 개요
===============================================================================

응용 프로그램 마법사에서 이 Gaia 응용 프로그램을 
만들었습니다. 이 응용 프로그램은 MFC의 기본 사용법을 보여 줄 뿐만 아니라 응용 프로그램
작성을 위한 기본 구조를 제공합니다.

이 파일에는 Gaia 응용 프로그램을 구성하는 각 파일에 대한
요약 설명이 포함되어 있습니다.
...
Gaia.h
    ...
    헤더(Resource.h 포함)가 들어 있고 GaiaApp 응용 프로그램
    클래스를 선언합니다.

Gaia.cpp
    응용 프로그램 클래스 GaiaApp이(가) 들어 있는 기본 응용 프로그램
    소스 파일입니다.
...
res\Toolbar.bmp
 ...
 리소스 편집기를 사용하여 이 도구 모음 비트맵을 편집하고
    Gaia.rc의 IDR_MAINFRAME TOOLBAR 배열을 업데이트하여 도구 모음
    단추를 추가합니다.
/////////////////////////////////////////////////////////////////////////////

응용 프로그램 마법사에서 하나의 문서 형식과 하나의 뷰가 만들어집니다.

GaiaDoc.h, GaiaDoc.cpp - 문서
    이 파일에는 GaiaDoc 클래스가 들어 있습니다. 이 파일을 편집하여
    특수한 문서 데이터를 추가하고 GaiaDoc::Serialize를 통해 파일
    저장 및 로드를 구현합니다.
    이 문서에는 다음 문자열이 포함됩니다.
        파일 확장명:      gff
        파일 형식 ID:        Gaia.Document
        주 프레임 캡션:  Gaia
        문서 형식 이름:       Gaia
        필터 이름:         Gaia Files (*.gff)
        파일의 새 약식 이름: Gaia
        파일 형식의 긴 이름: Gaia.Document

GaiaView.h, GaiaView.cpp - 문서 뷰
    이 파일에는 GaiaView 클래스가 들어 있습니다.
    GaiaView 개체는 GaiaDoc 개체를 보는 데 사용됩니다.
...
StdAfx.h, StdAfx.cpp
    이 파일은 미리 컴파일된 헤더 파일(PCH)인 Gaia.pch와
